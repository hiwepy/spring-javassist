...
public class EndpointApiCtClassBuilder implements Builder<CtClass> {
	...
	public EndpointApiCtClassBuilder(final String classname, final Class<?> superclass) throws CannotCompileException, NotFoundException  {
		this(ClassPoolFactory.getDefaultPool(), classname, superclass);
	}
	
	public EndpointApiCtClassBuilder(final ClassPool pool, final String classname, final Class<?> superclass) throws CannotCompileException, NotFoundException {
	 ...
	 * @throws NotFoundException  if not found
	 */
	public EndpointApiCtClassBuilder autowiredHandler(boolean required, String qualifier) throws CannotCompileException, NotFoundException {
     ...
     * @throws CannotCompileException if can't compile
     */
	public EndpointApiCtClassBuilder makeField(final String src) throws CannotCompileException {
		//创建属性
	...
	public EndpointApiCtClassBuilder removeField(final String fieldName) throws NotFoundException {
     ...
     * @throws CannotCompileException if can't compile
     */
	public EndpointApiCtClassBuilder makeMethod(final String src) throws CannotCompileException {
		//创建方法 
